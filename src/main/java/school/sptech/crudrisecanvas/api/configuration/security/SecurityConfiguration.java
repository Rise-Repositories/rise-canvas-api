package school.sptech.crudrisecanvas.api.configuration.security;
...
import school.sptech.crudrisecanvas.service.AuthService;
...
public class SecurityConfiguration {
    ...
    @Autowired
    private AuthEntryPoint autenticacaoJwtEntryPoint;
...
//            new AntPathRequestMatcher("/**"),
    ...
    public AuthenticationManager authManager(HttpSecurity http) throws Exception {
        ...
        authenticationManagerBuilder.authenticationProvider(new
                AuthProvider(autenticacaoService, passwordEncoder()));
    ...
    public AuthFilter jwtAuthenticationFilterBean() {
        return new AuthFilter(autenticacaoService, jwtAuthenticationUtilBean());
    }
